...
public:
	...
	virtual void SetPositionMilliSec(int millisec) = 0;
...
public:
	...
	virtual void SetPositionMilliSec(int millisec);
...
public:
	...
	virtual DWORD GetPosition() { return 0; }
	virtual UINT GetLengthMSec(){ return 0; }
