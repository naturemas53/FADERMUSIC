...
GreatBomb::GreatBomb() : JudgeBomb(350, 5, 5, Vector2(120.0f, 120.0f),GREAT){

	if (this->sprite_ == nullptr){

		this->sprite_ = GraphicsDevice.CreateSpriteFromFile(_T("bomb/orenge_bomb.png"));
...
void GreatBomb::Init(Vector3 faderpos, Vector2 fader_inner, float height){
...
int GreatBomb::Update(int elapsedtime){
