#include "UnbelievableBomb.h"

SPRITE UnbelievableBomb::sprite_ = nullptr;

UnbelievableBomb::UnbelievableBomb() :JudgeBomb(350,5,5,Vector2(120.0f,120.0f),UNBELIEVABLE){

	if (this->sprite_ == nullptr){

		this->sprite_ = GraphicsDevice.CreateSpriteFromFile(_T("bomb/rainbow_bomb.png"));

	}

}

UnbelievableBomb::~UnbelievableBomb(){
...
void UnbelievableBomb::Init(Vector3 faderpos, Vector2 fader_inner, float height){
...
int UnbelievableBomb::Update(int elapsedtime){
