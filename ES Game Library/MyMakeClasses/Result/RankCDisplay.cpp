...
RankCDisplay::RankCDisplay() :AbstructRankDisplay(Vector2(258.0f, 320.0f), Vector3(870.0f, 360.0f, 0.0f)),
STARTPOS_(Vector3(1280, 360.0f, 0.0f)),
MOVETIME_(150){

	this->ranksprite_ = GraphicsDevice.CreateSpriteFromFile(_T("result/rank/result_rank_C.png"));
...
int RankCDisplay::Update(int elapsedtime){
